...
def main():
    ...
    base_directory = os.path.join("..", "data", "scraped_data")
        ...
        for file in files:
            if file.endswith('.txt'):
                ...
                try:
                    ...
                    # Create vector with relative file path in metadata
    ...
    print(f"Successfully uploaded {count} vectors to Pinecone index '{INDEX_NAME}' in namespace '{NAMESPACE}'")
